...
##########################################################
root='/data_1/ssd-project/SSD_data_augment/'
...
#annroot=root+'xml/'
#picroot=root+'img/'
annroot='/data_1/ssd-project/SSD_data_augment/xml_aug/'
picroot='/data_1/ssd-project/SSD_data_augment/jpg_aug/'
anns=os.listdir(annroot)
imgs=os.listdir(picroot)

labelmap=["chepai","chebiao","chedeng"]
